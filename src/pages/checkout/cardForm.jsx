...
setLoading(true)
                                    ...
                                    <ul className="list-group mb-3">
                                        <li className="list-group-item d-flex justify-content-between lh-condensed">
                                            ...
                                            <div> <span className="">Price</span><br />
                                                <small className="text-muted">{ price===0?"Free": `₦ ${price}`}</small></div>
    ...
    <small className="text-muted">{price===0?"1 month":"12 months"}</small>
                                        </li>
                                                            ...
                                                            <div className={classes.actionsContainer}>
                                                                <div>
                                                                    ...
                                                                    <Button
                                                                        ...
                                                                        disabled={!email || !password || !confirmPassword ||!phone ||!fullName}
                                                                    >
                                                                        {/* {console.log('PCIRERICE:', price)} */}
                                                                        {index === 0 ? (loading?<Loader/>:'Submit') : <PaystackButton
                text="Make Payment"
                class="payButton"
                  callback={callback} 
                  close={close}                                 
