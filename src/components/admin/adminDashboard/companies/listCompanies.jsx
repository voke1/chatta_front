...
export default class CompaniesComponent extends Component {
    ...
    getAllCompanies = async () => {
        this.appService.getAllCompanies().then(
            (companiesResponse) => {
                const notification = { msg: "Sucessfully listed companies", type: "success" };
                this.setState({
        ...
        if (window.confirm("Are you sure?")) {
            fetch(`${BASE_URL}/company/` + companyId, {
                ...
                .then(data => {
                    this.setState({
                        companys: [
                            ...this.state.companys.filter(company => company._id !== companyId)
                        ]
                    });
                });
        }
    ...
    toggleSwitchf = async (id) => {
        ...
        await this.appService.toggleCompany(id, { isEnabled: !company.isEnabled }).then((companyResponse) => {
            const notification = {
                type: "success",
                msg: `${companyResponse.company_name || "Company"} successfully ${toggleMsg}d`
            }
    ...
    App = () => {
        ...
        return (
            <div>
                ...
                <LayoutHeader pageTitle={this.pageTitle}
                    ...
                    <div className="container-fluid">
                      ...
                      the construction function: <code>$().DataTable();</code>.
                                        ...
                                        <table id="datatable" className="table table-bordered">
                                            ...
                                            <tbody>
                                                <AppLoader tds={7} itemsLength={this.state.companies.length} loading={this.state.loading} />
                                                ...
                                                {this.state.companies.map((company, index) => (
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <Switch
                                                                key={company._id}
                                                                onClick={this.toggleSwitchf.bind(this, company._id)}
