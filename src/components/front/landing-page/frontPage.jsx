                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="single-pricing">
                                ...
                                <div className="single-pricing-content">
                                    <h5>Standard</h5>
                                    <h4>₦ 35,000<span className="currency_line">/</span><span>month</span></h4>
                                    <ul className="ul">
                                        <li>2GB Bandwidth</li>
                                        <li>Two Account</li>
                                        <li>15GB Storage</li>
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="single-pricing">
                                ...
                                <div className="single-pricing-content">
                                    <h5>Business</h5>
                                    <h4>₦ 25,000<span className="currency_line">/</span><span>month</span></h4>
                                    <ul className="ul">
                                        <li>2GB Bandwidth</li>
                                        <li>Two Account</li>
                                        <li>15GB Storage</li>
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="single-pricing">
                                ...
                                <div className="single-pricing-content">
                                    <h5>Premium</h5>
                                    <h4>₦ 20,000<span className="currency_line">/</span><span>month</span></h4>
                                    <ul className="ul">
                                        <li>2GB Bandwidth</li>
                                        <li>Two Account</li>
                                        <li>15GB Storage</li>
